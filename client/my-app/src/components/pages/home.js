...
<div className="home-page">
      ...
      <div className="banner-home">
        <img src={`${process.env.PUBLIC_URL}/assets/perroGato.png`} alt="Banner" className="banner-image-home" />
      ...
      <div className="objectives-home">
        ...
        <div className="objective-card-home">
          <img src={`${process.env.PUBLIC_URL}/assets/perroGato.jpg`} alt="Objective" />
